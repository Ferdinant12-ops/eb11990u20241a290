package com.whirlpool.care.platform.u20241a290.shared.application.result;
...
/**
 * Represents the result of an operation that either succeeds with a value or fails with an error.
 *
